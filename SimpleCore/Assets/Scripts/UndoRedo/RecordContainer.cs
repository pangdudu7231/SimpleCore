...
namespace SimpleCore.UndoRedoes
{
    ...
    public sealed class RecordContainer
    {
        ...
        public Action<IRecord> OnBeforeRecordHandler; //记录新的撤销还原之前的回调
        public Action<IRecord> OnEndRecordHandler; //记录新的撤销还原之后的回调
        public Action<IRecord> OnBeforeUndoHandler; //执行撤销之前的回调
        public Action<IRecord> OnEndUndoHandler; //执行撤销之后的回调
        public Action<IRecord> OnBeforeRedoHandler; //执行还原之前的回调
        public Action<IRecord> OnEndRedoHandler; //执行还原之后的回调
        ...
        public RecordContainer(int limit)
        {
            _limit = limit;
        ...
        public void Record(IRecord record)
        {
            ...
            OnBeforeRecordHandler?.Invoke(record);
        ...
        public void Undo()
        {
            ...
            OnBeforeUndoHandler?.Invoke(record);
            UndoInternal();
        ...
        public void Redo()
        {
            ...
            OnBeforeRedoHandler?.Invoke(record);
            RedoInternal();
        ...
        public void Clear()
        {
            ...
            //清空注册事件
            OnBeforeRecordHandler = null;
            OnEndRecordHandler = null;
            OnBeforeUndoHandler = null;
            OnEndUndoHandler = null;
            OnBeforeRedoHandler = null;
