...
namespace SimpleCore.ShapeMeshes
{
    ...
    public sealed class BoxShapeMesh : BaseShapeMesh
    {
        ...
        public BoxShapeMesh(float xSize, float ySize, float zSize, bool isDoubleSide = true,
            string meshName = "BoxMesh", MeshPivot meshPivot = MeshPivot.Center) : base(meshName, meshPivot)
        {
            _xSize = xSize;
            _ySize = ySize;
            _zSize = zSize;
        ...
        protected override Vector3[] GetVertices(Vector3 vertexOffset)
        {
            ...
            return _isDoubleSide ? GetDoubleSizeVertices(points) : GetSingleSideVertices(points);
        }
        ...
        /// <param name="points"></param>
        /// <returns></returns>
        private static Vector3[] GetDoubleSizeVertices(IReadOnlyList<Vector3> points)
        {
            return new[]
            {
                //下
