...
namespace SimpleCore.ShapeMeshes
{
    ...
    ///     立方体图形单面 mesh类。
    /// </summary>
    public sealed class BoxShapeSingleSideMesh : BoxShapeMesh
    {
        #region ctor
        ...
        public BoxShapeSingleSideMesh(float xSize, float ySize, float zSize, string meshName, MeshPivot meshPivot) :
